...
if(${_var})
    ...
    if(CCACHE_PROGRAM)
        ...
        configure_file(${CMAKE_CURRENT_LIST_DIR}/launch-cxx.in ccache.cmake/launch-cxx)
        ...
        execute_process(COMMAND chmod a+rx "${CCACHE_LAUNCH_C}" "${CCACHE_LAUNCH_CXX}")

        if(CMAKE_GENERATOR STREQUAL "Xcode")
            # Set Xcode project attributes to route compilation and linking
            # through our scripts
            set(CMAKE_XCODE_ATTRIBUTE_CC         "${CCACHE_LAUNCH_C}"   CACHE INTERNAL "")
            set(CMAKE_XCODE_ATTRIBUTE_CXX        "${CCACHE_LAUNCH_CXX}" CACHE INTERNAL "")
            set(CMAKE_XCODE_ATTRIBUTE_LD         "${CCACHE_LAUNCH_C}"   CACHE INTERNAL "")
            set(CMAKE_XCODE_ATTRIBUTE_LDPLUSPLUS "${CCACHE_LAUNCH_CXX}" CACHE INTERNAL "")
        else()
            # Support Unix Makefiles and Ninja
            set(CMAKE_C_COMPILER_LAUNCHER   "${CCACHE_LAUNCH_C}"   CACHE INTERNAL "")
            set(CMAKE_CXX_COMPILER_LAUNCHER "${CCACHE_LAUNCH_CXX}" CACHE INTERNAL "")
        endif()
